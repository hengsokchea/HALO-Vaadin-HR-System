...
@Service
public class GoalSettingEntryService implements GenericService<GoalSetting> {
	  ...
	  public GoalSettingEntryService(GoalSettingRepository repository,AuthenticatedUser authenticatedUser,GoalSettingDetailRepository goalSettingDetailRepository) {
	  ...
	  public GoalSetting update(GoalSetting entityValue) {
	      ...
	      if (!authenticatedUser.hasPage(GoalSettingEntryView.class, accessPageType)) {
