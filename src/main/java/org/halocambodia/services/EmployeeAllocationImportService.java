...
@Service
public class EmployeeAllocationImportService implements GenericService<EmployeeAllocation> {

    private final EmployeeAllocationRepository repository;
    private final AuthenticatedUser authenticatedUser;


    public EmployeeAllocationImportService(EmployeeAllocationRepository repository,AuthenticatedUser authenticatedUser ) {
    ...
    @Override
    public void delete(Set<EmployeeAllocation> entity) {
