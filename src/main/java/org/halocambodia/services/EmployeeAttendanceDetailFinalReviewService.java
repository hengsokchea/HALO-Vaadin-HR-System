...
@Service
public class EmployeeAttendanceDetailFinalReviewService implements GenericService<EmployeeAttendanceDetail> {
	  ...
	  public EmployeeAttendanceDetailFinalReviewService(EmployeeAttendanceDetailRepository repository,
	  ...
	  public void delete(Set<EmployeeAttendanceDetail> entities) {
	      if (!authenticatedUser.hasPage(AttendanceFinalReviewView.class, AccessPageType.DELETED_PAGE)) {
	  ...
	  public EmployeeAttendanceDetail update(EmployeeAttendanceDetail incoming) {
	      ...
	      if (!authenticatedUser.hasPage(AttendanceFinalReviewView.class, accessPageType)) {
