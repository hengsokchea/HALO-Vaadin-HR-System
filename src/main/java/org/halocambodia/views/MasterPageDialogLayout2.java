...
public abstract class MasterPageDialogLayout2<T, S extends GenericService<T>> extends VerticalLayout{
    ...
    public MasterPageDialogLayout2(S service,UserService userService,AuthenticatedUser authenticatedUser) {
   ...
   protected void showHideAdvanceFilter(String message) {
    ...
    private HorizontalLayout createToolBarLayout() {
        ...
        HorizontalLayout rightToolbar = new HorizontalLayout(txtQuick, btnFilter, btnClearFilter,btnAdvanceSearch,exportToExcelFile());
