...
import org.halocambodia.services.EmployeePerformanceSummaryService;
...
@Route(value = "performance-summary", layout = MainLayout.class)
@PageTitle("Performance Summary")
@PermitAll
public class EmployeePerformanceSummaryView extends PageDialogLayout<EmployeePerformanceReview, EmployeePerformanceSummaryService> {
    ...
    public EmployeePerformanceSummaryView(EmployeePerformanceSummaryService service, UserService userService,AuthenticatedUser authenticatedUser, PositionRepository positionRepository,EmployeeRepository employeeRepository,BranchRepository branchRepository,PerformanceStatusRepository performanceStatusRepository,PasswordEncoder passwordEncoder,FileUploadUtility fileUploadUtility) {
    ...
    protected void onViewAttachOnce(AttachEvent attachEvent) throws Exception {
        ...
        MenuItem miPrint=leftMenu.addAction(VaadinIcon.PRINT,null, this::print,"Print");
    ...
    private void print() {
        ...
        java.util.Set<Long> ids = grid.getSelectedItems().stream()
                .map(EmployeePerformanceReview::getId)
    ...
    private void generateReportForm(Collection<Long> Ids) {
        ...
        parameters.put("emp_performance_review_id", Ids); // ✅ Collection<Long>
        ...
        PreviewReport previewReport =  new PreviewReport("report_embed/redundancy_form.jasper", parameters);
        previewReport.open();
    }
    ...
    protected EmployeePerformanceReview createNewEntity() {
        ...
        r.setBranch(br);
        r.setSupervisorStatus(performanceStatusRepository.findByStatusNameIgnoreCase("DRAFT").orElseThrow());
    ...
    private void rebuildCriteriaUI() {
        ...
        List<EmployeePerformanceSummaryService.GroupWithCriteria> gwcs = service.loadActiveCriteria();
        ...
        return (root, query, cb) -> {
            try {
               ...
               //query.distinct(true);
                ...
                predicates.add(finalStatusJoin.get("statusName").in("APPROVED"));
