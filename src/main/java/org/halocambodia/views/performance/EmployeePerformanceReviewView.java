...
@Route(value = "performance-review", layout = MainLayout.class)
@PageTitle("Performance Review")
@PermitAll
public class EmployeePerformanceReviewView        extends PageDialogLayout<EmployeePerformanceReview, EmployeePerformanceReviewService> {
    ...
    protected void configureEditorLayout() throws Exception {
        ...
        Div commentsWrap = new Div(managerComments);
    ...
    private void rebuildCriteriaUI() {
        ...
        List<EmployeePerformanceReviewService.GroupWithCriteria> gwcs = service.loadActiveCriteria();
    ...
    protected List<ColumnDef<EmployeePerformanceReview>> getColumnDefs() {
        return List.of(
                ...
                col("finalStatus", "Final Review Status",EmployeePerformanceReview::getFinalStatus, e -> e.getFinalStatus() == null ? "" : e.getFinalStatus().getStatusName()),
    ...
    protected Specification<EmployeePerformanceReview> buildCombinedSpecification() {
        return (root, query, cb) -> {
            try {
                ...
                predicates.add(cb.equal(supervisorJoin.get("insuranceNo"), loginInsuranceNo));
                
                predicates.add(supervisorStatusJoin.get("statusName").in("DRAFT","SUBMITTED"));
